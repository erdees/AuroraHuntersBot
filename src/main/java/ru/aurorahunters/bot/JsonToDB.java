...
public class JsonToDB implements Runnable {
    ...
    private final String mag5minURL = "https://services.swpc.noaa.gov/products/solar-wind/mag-5-minute.json";
    private final String plasma5minURL = "https://services.swpc.noaa.gov/products/solar-wind/plasma-5-minute.json";
    private final String mag2hourURL = "https://services.swpc.noaa.gov/products/solar-wind/mag-2-hour.json";
    private final String plasma2hourURL = "https://services.swpc.noaa.gov/products/solar-wind/plasma-2-hour.json";
    private final String mag1dayURL = "https://services.swpc.noaa.gov/products/solar-wind/mag-1-day.json";
    private final String plasma1dayURL = "https://services.swpc.noaa.gov/products/solar-wind/plasma-1-day.json";
    private final String mag7dayURL = "https://services.swpc.noaa.gov/products/solar-wind/mag-7-day.json";
    private final String plasma7dayURL = "https://services.swpc.noaa.gov/products/solar-wind/plasma-7-day.json";
